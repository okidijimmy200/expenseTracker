...
const MainRouter = () => {
    return (<div>
      ...
      <Switch>
        ...
        {/* This NewExpense component can only be viewed by signed-in users. So, we will add
a PrivateRoute in the MainRouter component, which will render this form only for
authenticated users at /expenses/new  */}
